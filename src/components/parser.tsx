...
class DotParser {
  ...
  private readKeyword(): string {
    ...
    while (this.currentIndex < this.input.length && this.isAlphaNumeric(this.input[this.currentIndex])) {
      this.currentIndex++;
    }
  ...
  private readIdentifier(): string {
    ...
    while (
      ...
      (this.isAlphaNumeric(this.input[this.currentIndex]) || this.input[this.currentIndex] === '_')
    ) {
      this.currentIndex++;
    }
    return this.input.slice(start, this.currentIndex);
  ...
  private skipWhitespace(): void {
    while (this.currentIndex < this.input.length && this.isWhitespace(this.input[this.currentIndex])) {
      this.currentIndex++;
    }
  }
  ...
  private expect(expected: string): void {
    if (this.input[this.currentIndex] !== expected) {
      throw new Error(`Expected '${expected}' at position ${this.currentIndex}`);
    }
    this.currentIndex++;
  }
